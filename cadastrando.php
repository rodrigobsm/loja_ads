<?php
	...
	//forca usuário a digitar senha com 7 caracteres no minimo
	if (strlen($senha)< 8){
		...
		if(@mysql_num_rows($search) > 0){
			...
			$queryCadastro = "INSERT INTO clientes (nome, email, senha, cpf, tel_area, tel_numero, cep, logradouro, numero, complemento, bairro, cidade, uf) VALUES ('$nome', '$email','md5($senha)','$cpf','$tel_area','$tel_numero','$cep','$logradouro','$numero','$complemento','$bairro','$cidade','$uf')";
